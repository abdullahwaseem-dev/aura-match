...
import 'package:aura_match/screens/jobs/jobs_flow_screen.dart';
...
void main() {
  testWidgets('Jobs Feed tab prompts for a resume scan when none exists', (tester) async {
    final api = ApiClient();
    await tester.pumpWidget(
      MultiProvider(
        ...
        child: const MaterialApp(home: Scaffold(body: JobsFlowScreen())),
      ),
    );
    await tester.pump();
