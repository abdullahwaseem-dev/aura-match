      ...
      child: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              'Aura rewrites and optimizes using only what\'s already in your resume — it never invents experience.',
              textAlign: TextAlign.center,
              style: AuroraText.bodySm.copyWith(color: AuroraColors.mistDim, fontSize: 11.5),
            ),
            const SizedBox(height: AuroraSpacing.lg),
            AuroraButton(
              label: 'Answer a few questions to close real gaps first',
              variant: AuroraButtonVariant.ghost,
              expand: true,
              onPressed: state.loading ? null : () => context.read<ResumeState>().beginQa(),
            ),
          ],
        ),
      ),
